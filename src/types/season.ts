...
export interface Season {
  ...
  /** The threshold chart this season uses. NULL = use league default at runtime. */
 ...
 * This automatically stays in sync when Season type changes
 * Note: Holidays and championships NOT stored - fetched on-demand during editing
 */
export type SeasonInsertData = Omit<Season,
  | 'id'                  // Auto-generated by database
  | 'season_completed'    // Has default value in database (false)
  | 'threshold_chart_id'  // Optional - NULL = use league default
