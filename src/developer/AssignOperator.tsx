 ...
 *
 * Note: the developer master key is deliberately NOT grantable here. It bypasses
 * every permission and designation check, so it has no UI entry point — it is
 * assigned by hand (a single SQL update). The most dangerous privilege gets the
 * smallest surface.
 *
