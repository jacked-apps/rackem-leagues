...
> **Last Updated**: 2026-06-04 (Per-Game Allocator Workshop brainstorm + implementation plan: `docs/brainstorms/2026-06-04-per-game-allocator-workshop-requirements.md` + `docs/plans/2026-06-04-001-feat-per-game-allocator-workshop-plan.md` — first modules-as-data application; 7 units across DB schema, loader, swap wiring, workshop UI, league picker + sanity preview, 17-Point smoke test. Branch `feat/per-game-allocator-workshop`.)
...
| `docs/brainstorms/2026-06-04-per-game-allocator-workshop-requirements.md` | Workshop for LO-authored per-game allocator variations (modules-as-data first application) — DB-row variations + per-league pointer + swap point in `pickPointsSystem`; engine already supports fixed/range/formula, only the workshop pipeline is missing | Ready for planning; branch `feat/per-game-allocator-workshop` |
| `/docs/plans/` | **CE implementation plans** | Output of `/compound-engineering:ce-plan` |
| `docs/plans/2026-04-17-001-feat-official-rulebook-reader-plan.md` | Implementation plan for the Official Rulebook Reader | 6 units, active branch `feature/official-rulebook-reader` |
...
| `docs/plans/2026-06-04-001-feat-per-game-allocator-workshop-plan.md` | Implementation plan for the Per-Game Allocator Workshop — first modules-as-data application | 7 units: DB schema (table + preferences FK + view), loader, pickPointsSystem swap wiring, workshop UI (list + editor + side editor), league-settings picker + sanity preview, 17-Point composition + smoke test, TOC/cleanup. Branch `feat/per-game-allocator-workshop` |
