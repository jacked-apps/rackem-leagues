...
| `docs/brainstorms/2026-06-30-ozzy-meeting-prep.md` | Meeting script / strategic spine for the Ozzy + Fargo/CSI pitch — disarm the LMS-competitor read, the APA-vs-BCA culture + growth-wall thesis, the "both orgs want more players paying" bridge, the honest layer-vs-integration answer, two asks (rating API + reference math), demo-readiness checklist | Companion to `2026-05-17-bca-pitch-strategy.md`; outreach email sent ~2026-06-29, awaiting reply; branch `docs/bca-meeting-prep` |
