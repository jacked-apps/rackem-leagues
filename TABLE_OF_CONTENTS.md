...
> **Last Updated**: 2026-05-28 (Added operator-help-system brainstorm: `docs/brainstorms/2026-05-28-operator-help-system-requirements.md` — phased operator-facing help architecture: glossary data source + InfoButton coverage in Phase 1, persistent Help button + Walkthroughs/Concepts deferred to Phase 2.)
