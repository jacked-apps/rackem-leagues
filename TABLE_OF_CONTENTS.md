...
- `seasonLengthEdit.ts` - Pure season-length eligibility (week-5 lock) + [10,52] bounds/classification
- `applySeasonLengthChange.ts` - Lengthen (append weeks + generate matches) / shorten (guarded tail delete) for an existing season
