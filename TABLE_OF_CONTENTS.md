...
| `docs/league-system/modules/win-calculator-v2.md` | Win Calculator v2 DRAFT — pure judge + comparator switch + win chip; proposed replacement for win-calculator.md (2026-05-23 brainstorm) | DRAFT (unlocked) |
