...
> **Last Updated**: 2026-06-04 (Foundational framing: `docs/brainstorms/2026-06-04-scoring-system-workshop-building-requirements.md` — Scoring System Workshop is a BUILDING with one work room per module type; build room-by-room starting with per-game point allocator; two non-negotiables (lineup/scoring page renders + per-game W/L recording survives any variation failure). Supersedes earlier 2026-06-04 brainstorm + plan on this branch which jumped to feature design before locking the framing. Branch `feat/per-game-allocator-workshop`.)
...
| `docs/plans/2026-06-04-001-feat-per-game-allocator-workshop-plan.md` | Implementation plan for the Per-Game Allocator Workshop | SUPERSEDED 2026-06-04 by the building-framing brainstorm — this plan was built on the pre-framing brainstorm and put the swap in the wrong file. A new plan will be written from the building framing. Kept for history |
