...
> **Last Updated**: 2026-09-16 (BUILT Game Room Unit 2 — `20260916184405_game_rooms_sweep.sql`: `sweep_stale_rooms` on an hourly pg_cron job; 5 db tests. Full db suite 78 files / 606 green from a scratch reset in CI order. Unit 1 (rooms + room_phones + RPCs, 28 tests) landed earlier today.)
