...
| `docs/league-system/concept-analogies.md` | Lens mapping locked concepts → programming primitives (Module=component, Threshold=state setter, Trigger=if/then…); flaw-detector for cold reads | CANDIDATE for canonization (UNLOCKED) |
