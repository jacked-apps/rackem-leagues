...
> **Last Updated**: 2026-05-28 (Added passwordless sign-in brainstorm: `docs/brainstorms/2026-05-28-passwordless-sign-in-requirements.md` — one-door, code-based login (email OTP + Google/Facebook), passwords kept but demoted. Companion to the player-onboarding cold-start brainstorm; built first. Branch `docs/passwordless-auth-brainstorm`.)
